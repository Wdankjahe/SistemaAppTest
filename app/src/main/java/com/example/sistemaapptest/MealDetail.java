...
public class MealDetail {
    ...
    @Expose
    private String mealCreativeCommon;

    @SerializedName("dateModified")
    @Expose
    private String mealDateModified;
    ...
    public String getMealCreativeCommon() {
        return mealCreativeCommon;
    }

    public void setMealCreativeCommon(String mealCreativeCommon) {
        this.mealCreativeCommon = mealCreativeCommon;
    }

    public String getMealDateModified() {
        return mealDateModified;
    }

    public void setMealDateModified(String mealDateModified) {
        this.mealDateModified = mealDateModified;
    }
